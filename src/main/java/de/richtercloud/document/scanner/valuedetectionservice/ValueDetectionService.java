...
public interface ValueDetectionService<T> {
    String LANGUAGE_CHINESE = Locale.CHINESE.getLanguage();
    String LANGUAGE_ENGLISH = Locale.ENGLISH.getLanguage();
    String LANGUAGE_FRENCH = Locale.FRENCH.getLanguage();
    String LANGUAGE_GERMAN = Locale.GERMAN.getLanguage();
    String LANGUAGE_SPANISH = Locale.forLanguageTag("es").getLanguage();

    static String retrieveLanguageIdentifier(Locale locale) {
    ...
    */
     ...
     * @throws ResultFetchingException encapsulates information about eventual failure during fetching the result
     */
