...
public class ValueDetectionResult<T> {
     ...
     *
     * @param oCRSource the text where the result was found in
     * @param result the found result
     */
    public ValueDetectionResult(String oCRSource,
            T result) {
    ...
    public boolean equals(Object obj) {
        ...
        final ValueDetectionResult<?> other = (ValueDetectionResult<?>) obj;
